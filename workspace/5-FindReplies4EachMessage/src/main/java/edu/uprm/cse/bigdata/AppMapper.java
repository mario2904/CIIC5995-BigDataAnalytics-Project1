    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        try {
            ...
            if(tweetStatus.getInReplyToStatusId() != -1) {
                String originalStatusId = String.valueOf(tweetStatus.getInReplyToStatusId());
                String replyStatusId = String.valueOf(tweetStatus.getId());
                context.write(new Text(originalStatusId), new Text(replyStatusId));
            }
        }
